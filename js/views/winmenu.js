webix.protoUI({
	...
	type:{
		template:function(obj){
			var result = "";
			if (obj.icon){
				result = "<span class='webix_icon mdi mdi-" + obj.icon + "'></span><div>" + obj.value + "</div>";
			}
			else if (obj.img){
				result ="<div class='bg_img' style='background-image:url(" + obj.img + ");'><div class='title'>"+obj.value+"</div></div>";
			}
			return result;
		},
